...
<body>
	...
	<div class="full-title">
		<div class="container">
			...
			<h1 class="mt-4 mb-3">Seeds AgriLanka
	...
	<div class="project-inner">
		...
		<div class="row">
			<div class="col-md-7">
				<a href="#">
					<img class="img-fluid rounded mb-3 mb-md-0" src="images/freshvegetable.jpg" alt="" />
				</a>
			</div>
			<div class="col-md-5">
            <form action="seedForm.php"method="post">
