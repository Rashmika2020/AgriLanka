...
<body>
	...
	<div class="full-title">
		<div class="container">
			...
			<h1 class="mt-4 mb-3">Fertilizers AgriLanka
	...
	<div class="project-inner">
		...
		<div class="row">
			<div class="col-md-7">
				<a href="#">
                <img class="img-fluid rounded mb-3 mb-md-0" src="images/team_01.jpg" alt="" />
				</a>
			</div>
			<div class="col-md-5">
            <form action="fertilizerForm.php"method="post">
